...
Simple but with all core production features
"""
...
class ProductionDatabase:
    ...
    def cleanup_old_backups(self):
        ...
        try:
            ...
            cutoff_date = datetime.now() - timedelta(days=30 * 2)
...
<file_path>
my-project\simple-proposal-system-v2\backend\run.py</file_path>

<edit_description>
>Create super simple production backend</edit_description>
